...
import { LoggingTypes, DefaultFormatConfig, FormatTypes, Colors, } from "./types.js";
...
export class LoggingBase {
    constructor(options, adapterSet) {
        this._formatMap = new DefaultFormatConfig();
        this.adapter_init = [];
        this.timerMap = new Map();
        this.messageObservable = new Observable();
        this._logLevel = LoggingTypes.Debug;
        ...
        let config = Object.assign({ name: undefined, console: true, resolve_filename: true }, opt);
        if (config.name)
...
export function withColor(color, value) {
    return {
        [colorSymbol]: color,
        value,
    };
